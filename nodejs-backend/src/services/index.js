...
const landtitle = require("./landtitle/landtitle.service.js");
const titleowner = require("./titleowner/titleowner.service.js");
...
module.exports = function (app) {
  ...
  app.configure(landtitle);
  app.configure(titleowner);
