...
import SingleLandtitlePage from "../components/LandtitlePage/SingleLandtitlePage";
import LandtitleProjectLayoutPage from "../components/LandtitlePage/LandtitleProjectLayoutPage";
import SingleTitleownerPage from "../components/TitleownerPage/SingleTitleownerPage";
import TitleownerProjectLayoutPage from "../components/TitleownerPage/TitleownerProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/landtitle/:singleLandtitleId" exact element={<SingleLandtitlePage />} />
<Route path="/landtitle" exact element={<LandtitleProjectLayoutPage />} />
<Route path="/titleowner/:singleTitleownerId" exact element={<SingleTitleownerPage />} />
<Route path="/titleowner" exact element={<TitleownerProjectLayoutPage />} />
