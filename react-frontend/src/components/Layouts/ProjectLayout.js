...
import TitleownerPage from "../TitleownerPage/TitleownerPage";
// ~cb-add-import~
  ...
  const renderChild = (page) => {
    switch (page) {
      ...
      case "dash":
        return <Dashboard />;
case "landtitle":
                return <LandtitlePage />;
case "titleowner":
                return <TitleownerPage />;
      /* ~cb-add-thurthy~ */
      default:
...
<li
                onClick={() => {
                  setCurrentActiveTab2("landtitle");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "landtitle",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "landtitle" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "landtitle",
                      "text-black": props?.currentActiveTab2 !== "landtitle",
                    })}
                  >
                  Landtitle
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "landtitle",
                      "text-yellow-700": props?.currentActiveTab2 !== "landtitle",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("titleowner");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "titleowner",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "titleowner" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "titleowner",
                      "text-black": props?.currentActiveTab2 !== "titleowner",
                    })}
                  >
                  Titleowner
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "titleowner",
                      "text-yellow-700": props?.currentActiveTab2 !== "titleowner",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
